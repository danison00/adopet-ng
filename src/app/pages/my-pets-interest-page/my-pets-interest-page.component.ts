...
@Component({
  selector: 'app-my-pets-interest-page',
  templateUrl: './my-pets-interest-page.component.html',
  styleUrls: ['./my-pets-interest-page.component.scss']
})
export class MyPetsInterestPageComponent {
